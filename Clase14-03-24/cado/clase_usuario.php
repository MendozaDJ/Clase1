...
class Usuario{
	function listar(){
		...
		$sql="select u.id,u.nombre as Nombres,user as Usuario, pass as clave , u.estado,ug.nombre as 
		Grupo,u.id_grupo_usu, u.user_activo from usuario u inner join usuario_grupo ug on (u.id_grupo_usu=ug.id) 
		where user_activo=0;";
